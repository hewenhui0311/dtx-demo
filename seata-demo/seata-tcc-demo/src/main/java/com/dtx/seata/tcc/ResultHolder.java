...
public class ResultHolder {
    ...
    public static void removeActionOneResult(String txId) {
    	actionOneResults.remove(txId);
    }
    
    public static void removeActionTwoResult(String txId) {
    	actionTwoResults.remove(txId);
    }
